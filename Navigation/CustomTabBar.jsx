...
const CustomTabBar = React.memo(function CustomTabBar() {
    ...
    return (
        <View style={[styles.tabBar, { height: barHeight }]}>
            ...
            >
                <Path d={buildBackgroundPath(width, pathHeight)} fill={colors.backgroundSecondary} />
            </Svg>
            ...
            <View style={styles.row}>
                ...
                >
                    ...
                    />
                    <Text style={[styles.tabLabel, { color: startActive ? colors.primaryText : colors.thirdText }]}>
                        Start
                    </Text>
                </Pressable>
                ...
                >
                    ...
                    />
                    <Text style={[styles.tabLabel, { color: findEventActive ? colors.primaryText : colors.thirdText }]}>
                        Wydarzenia
                    </Text>
                </Pressable>
                ...
                >
                    ...
                    />
                    <Text style={[styles.tabLabel, { color: mapActive ? colors.primaryText : colors.thirdText }]}>
                        Obiekty
                    </Text>
                </Pressable>
                ...
                >
                    ...
                    <Text style={[styles.tabLabel, { color: chatActive ? colors.primaryText : colors.thirdText }]}>
                        Czat
                    </Text>
                </Pressable>
            </View>
