        ...
        <>
            ...
            <GestureDetector gesture={swipeGesture}>
                <Animated.View style={[styles.drawerPanel, drawerAnimatedStyle]}>
                    <LinearGradient
                        colors={[colors.secondaryCard, colors.primaryCard]}
                        start={{ x: 1, y: 0 }}
                        end={{ x: 0, y: 0 }}
                    ...
                    >
                        ...
                        <ScrollView style={styles.scrollContainer} contentContainerStyle={{ paddingBottom: insets.bottom }} showsVerticalScrollIndicator={false}>
                            ...
                            {/* Hidden screens */}
                            <DrawerItem icon='add-circle' label='Stwórz Wydarzenie' onPress={() => navigateTo('/(auth)/add-event')} styles={styles} />
                            <DrawerItem icon='trophy' label='Ranking' onPress={() => navigateTo('/(auth)/ranking')} styles={styles} />
                            <DrawerItem icon='star' label='Premium' onPress={() => navigateTo('/(auth)/premium')} styles={styles} />
                            <DrawerItem icon='person' label='Profil' onPress={() => navigateTo('/(auth)/profile')} styles={styles} />
                            <DrawerItem icon='settings-sharp' label='Ustawienia' onPress={() => navigateTo('/(auth)/settings')} styles={styles} />
                            ...
                            <View style={styles.closeButtonContainer}>
                                <Pressable
                                    ...
                                    android_ripple={{ color: colors.background }}
                                >
                                    <Ionicons name='chevron-back' size={moderateScale(32, 0.35)} color={colors.primaryText} />
                                    <Ionicons name='chevron-back' size={moderateScale(32, 0.35)} color={colors.primaryText} style={{ marginLeft: scale(16, 0.35) }} />
                                </Pressable>
                            </View>
                            ...
                            >
                                <Ionicons name='log-out' size={moderateScale(24, 0.35)} color={colors.Danger} />
...
function DrawerItem({ icon, label, onPress, styles }) {
    ...
    return (
        ...
        >
            <View style={styles.drawerItemContainer}>
                <Ionicons name={icon} size={moderateScale(28, 0.35)} color={colors.PrimaryGreen} />
...
const createStyles = (colors) =>
    StyleSheet.create({
        ...
        closeButtonX: {
            ...
            borderRadius: moderateScale(20, 0.35),
        },
        scrollContainer: {
            flex: 1,
        },
        ...
        drawerItemContainer: {
            ...
            paddingHorizontal: scale(20, 0.45),
            flexDirection: 'row',
