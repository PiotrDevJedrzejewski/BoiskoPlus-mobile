...
const MapLoadingScreen = React.memo(function MapLoadingScreen() {
  ...
  return (
    <View style={[mapLayoutStyles.loadingOverlay, { backgroundColor: colors.background }]} pointerEvents='none'>
      <LottieView
        source={spinner}
        autoPlay
        loop
  ...
  return (
    <View style={styles.container} pointerEvents='box-none'>
      ...
      <View style={styles.switcherContainer}>
        <Pressable style={[styles.switcherButton, switched ? styles.activeSwitcherButton : null]} onPress={() => setSwitched(true)}>
          <Ionicons
            name='map'
            size={scale(14, 0.25)}
            color={switched ? colors.background : colors.primaryText}
          />
          <Text style={[{ color: switched ? colors.background : colors.primaryText }, styles.switchButtonText]}>Mapa</Text>
        </Pressable>
        <Pressable style={[styles.switcherButton, !switched ? styles.activeSwitcherButton : null]} onPress={() => setSwitched(false)}>
          <Ionicons
            name='map'
            size={scale(14, 0.25)}
            color={!switched ? colors.background : colors.primaryText}
          />
          <Text style={[{ color: !switched ? colors.background : colors.primaryText }, styles.switchButtonText]}>Obiekty</Text>
        </Pressable>
      </View>
      {/* text input */}
      ...
      < View style={styles.controlsContainer}>
        ...
        >
          <Ionicons
            ...
            style={[styles.controlIconBasic, { opacity: showMarkers ? 1 : 0.5 }]}
          />
        </Pressable>
        ...
        >
          <MaterialIcons
            ...
            style={[styles.controlIconBasic, { opacity: showEvents ? 1 : 0.5 }]}
          />
        </Pressable>
      </View >
      <PlaceModal visible={!switched} closeModal={() => setSwitched(true)} />
      </View>
